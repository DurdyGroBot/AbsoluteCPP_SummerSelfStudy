...
int main(int argc, char *argv[]) {
    ...
    double retroactivePay = (previousAnnualSalary/2)*payIncrease;

    double newAnnualSalary = (previousAnnualSalary + retroactivePay);

    cout << "The retroactive pay is " << retroactivePay << endl;

    cout << "The new annual salary is " << newAnnualSalary << endl;

    cout << "The new monthly salary is " << newAnnualSalary/12;
